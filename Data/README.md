...
***Next step:*** A Jupyter Notebook that parses both the downloaded metadata and clinical data to generate these links and determine TNBC status of all cases, can be found in the **[DataLoading](../DataLoading)** folder that lives next to this Data folder.
